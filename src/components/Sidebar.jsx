...
export function Sidebar({
  ...
  return (
    <>
      ...
      <aside
        className={`fixed md:relative inset-y-0 left-0 z-50 bg-slate-950 flex flex-col transition-all duration-300 ease-in-out shadow-2xl md:shadow-none shrink-0 ${
          isOpen
            ? 'w-72 translate-x-0 border-r border-slate-800/90 opacity-100'
